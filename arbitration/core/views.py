...
from core.tasks import all_start_time, best_get_inter_exchanges_calculate
...
def start(request):
    ...
    group_crypto_exchanges = group(
        crypto_exchanges_start_time.s(), get_tinkoff_p2p_binance_exchanges.s(), get_wise_p2p_binance_exchanges.s(),
        chord(get_all_binance_crypto_exchanges.s(), get_all_card_2_wallet_2_crypto_exchanges.s()),
    ...
    general_group = group(all_start_time.s(), banks, crypto_exchanges)
    general_exchanges = chord(general_group, best_get_inter_exchanges_calculate.s())
    general_exchanges.delay()
